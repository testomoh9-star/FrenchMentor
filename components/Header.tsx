    ...
    <div className="flex items-center gap-2 h-8 sm:h-9">
      ...
      >
        ...
        <g id="LexiLift_Logo">
          ...
          <g id="Text" fill="#0f172a"> {/* slate-900 / dark text for professional look */}
            ...
            <path d="M658.59,42.9v39.45c0,5.63-3.21,8.32-9.35,8.32s-9.35-2.69-9.35-8.32v-39.45h-4.09c-4.97,0-7.45-2.05-7.45-6.15s2.48-6.27,7.45-6.27h4.09v-9.48c0-5.76,3.21-8.71,9.35-8.71s9.35,2.95,9.35,8.71v9.48h5.26c4.97,0,7.45,2.05,7.45,6.27s-2.48,6.15-7.45,6.15h-5.26Z"/>
          </g>
        </g>
      </svg>

      {isPro && (
        <span className="flex-shrink-0 mb-auto text-[8px] font-black text-indigo-600 bg-indigo-50 px-1 rounded border border-indigo-100/50">
