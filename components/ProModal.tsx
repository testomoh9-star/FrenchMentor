      ...
      >
        ...
        <div className="overflow-y-auto p-5 sm:p-8 flex flex-col items-center scrollbar-hide">
          ...
          <div className="text-center mb-5 sm:mb-6 pt-2">
            <h2 className="text-2xl sm:text-[1.75rem] font-black text-slate-900 leading-tight mb-1.5">
              Unlock LexiLift Pro
            </h2>
            <p className="text-slate-500 text-sm sm:text-[1rem] font-medium leading-snug max-w-[280px] sm:max-w-[300px] mx-auto">
              Learn faster. Fix mistakes once. Speak with confidence.
            </p>
          </div>

          {/* Features Card */}
          <div className="w-full bg-slate-50/50 border border-slate-100 rounded-2xl p-4 sm:p-6 mb-5 sm:mb-6">
            <ul className="space-y-3 mb-4 sm:mb-5">
              {features.map((feature, idx) => (
                <li key={idx} className="flex items-start gap-3">
                  ...
                  <span className="text-slate-700 text-xs sm:text-[0.935rem] font-bold leading-tight">
                    {feature}
                  </span>
                </li>
              ))}
            ...
            {/* Value Hint Box */}
            <div className="bg-indigo-50/50 rounded-xl p-3 sm:p-3.5 flex gap-2.5 sm:gap-3 items-start border border-indigo-100/50">
              <div className="mt-0.5 text-yellow-500 shrink-0">
                <Lightbulb size={16} fill="currentColor" className="opacity-40" />
              </div>
              <p className="text-indigo-900 text-[0.75rem] sm:text-[0.815rem] font-bold leading-snug">
          ...
          <div className="text-center mb-5 sm:mb-6">
            <div className="flex items-baseline justify-center gap-1.5">
              <span className="text-3xl sm:text-4xl font-black text-slate-900">$2.99</span>
              <span className="text-base sm:text-lg font-bold text-slate-500">/ month</span>
            </div>
            <p className="text-slate-400 text-[0.7rem] sm:text-[0.75rem] font-bold mt-0.5 tracking-tight">
          ...
          <div className="w-full space-y-3 sm:space-y-3.5 mb-6 sm:mb-8">
            <button 
              onClick={onUpgrade}
              className="w-full bg-gradient-to-r from-cyan-500 to-indigo-600 hover:from-cyan-600 hover:to-indigo-700 text-white py-3.5 sm:py-4 rounded-2xl font-black text-base sm:text-lg shadow-xl shadow-indigo-100 active:scale-[0.98] transition-all flex items-center justify-center gap-2"
            >
              Upgrade to Pro
            </button>
            <div className="flex items-center justify-center gap-2 text-slate-400 font-bold text-[0.65rem] sm:text-[0.7rem] uppercase tracking-widest">
          ...
          <div className="mt-auto pt-4 border-t border-slate-100 w-full text-center">
             <p className="text-slate-500 font-bold text-[0.75rem] sm:text-[0.8rem]">
